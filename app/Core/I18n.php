    ...
    private static function loadDictionary(string $locale): array {
        ...
        $dicts = [
            'en' => [
                ...
                'listen_audio_summary' => 'Listen to this Official Update (Audio Narration)',
            ...
            'bn' => [
                ...
                'listen_audio_summary' => 'এই বিজ্ঞপ্তিটির অডিও সারসংক্ষেপ শুনুন',
            ...
            'hi' => [
                ...
                'listen_audio_summary' => 'इस आधिकारिक सूचना का ऑडियो सारांश सुनें',
